...
<table class="table table--horizontal-borders">
	...
	<tbody>
		...
		<tr>
			...
			<td><span class="label label--warning">Required</span></td>
			<td>To make a distinction with the <code>&lt;nav&gt;</code> used in <a href="{% link _docs/modules/breadcrumb.md %}">breadcrumbs</a> or <a href="{% link _docs/modules/pagination.md %}">pagination</a>. Translate this string to your current locale.</td>
		</tr>
		<tr>
